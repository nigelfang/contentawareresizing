%% CSI4116: Homework 2
% Due: 10/5/2022, 11:59pm
% HW2 skeleton code script written by Seong Jae Hwang (seongjae@yonsei.ac.kr)
%
% This HW assignment has a long history from 
% - Adriana Kovashka (University of Pittsburgh)
% - Kristen Grauman (University of Texas, Austin)
%
% Do not distribute outside of class
%
% Follow through this pipeline to test your code, produce necessary
% outputs, and save results.
% I will be using my own script similar to this, so feel free to modify
% this script as needed.
% 
% To run the entire script, type in 'hw2' in Command Window.
% You can also run each Section (Right click anywhere in section -> Run Section)
...
% filename = 'my_image.PNG'; seamDirection = 'VERTICAL';

% Read the image
im = imread(filename);

%% Step 1: Simple gradient magnitude calculation.
% ***Function to implement: energy_image***
...
% horizontal seam = horizontal line to remove and resize the height
% vertical seam = vertical line to remove and resize the width
...
% ***Function to implement: reduceWidth***
% Hint: You are allowed to modify the provided reduceHeight code.
